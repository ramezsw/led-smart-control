...
class Adafruit_TSL2561(object):
    ...
    TSL2561_LUX_B5T           = 0x016f  # 0.0224 * 2^LUX_SCALE     TSL2561_LUX_M5T           = 0x01fc  # 0.0310 * 2^LUX_SCALE
    ...
    TSL2561_LUX_B5C           = 0x0177  # 0.0229 * 2^LUX_SCALE     TSL2561_LUX_M5C           = 0x01dd  # 0.0291 * 2^LUX_SCALE
    TSL2561_LUX_K6C           = 0x019a  # 0.80 * 2^RATIO_SCALE
    TSL2561_LUX_B6C           = 0x0101  # 0.0157 * 2^LUX_SCALE     TSL2561_LUX_M6C           = 0x0127  # 0.0180 * 2^LUX_SCALE
    TSL2561_LUX_K7C           = 0x029a  # 1.3 * 2^RATIO_SCALE     TSL2561_LUX_B7C           = 0x0037  # 0.00338 * 2^LUX_SCALE
